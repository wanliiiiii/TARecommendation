    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "detailAddress",
                    models.CharField(
                        default="", max_length=2550, verbose_name="景点详情地址"
                    ),
                ),
                (
                    "shortInfo",
                ...
                (
                    "detailIntro",
                    models.CharField(default="", max_length=255, verbose_name="详情介绍"),
                ),
                (
                    "img_list",
                    models.ImageField(
                        default="", max_length=2550, upload_to="", verbose_name="图片列表"
                    ),
                ),
                ("comments", models.TextField(default="", verbose_name="用户评论")),
                (
                    "cover",
                    models.CharField(default="", max_length=2550, verbose_name="封面"),
                ),
                (
                    "createTime",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "textarea",
                    models.CharField(default="", max_length=255, verbose_name="个人简介"),
                ),
                (
                    "createTime",
                    models.DateTimeField(
                        default="", max_length=255, verbose_name="创建时间"
                    ),
                ),
            ],
        ),
